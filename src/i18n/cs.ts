export const cs = {
  ...
  home: {
    ...
    habitsLeftToday: (n: number) =>
      `ještě ${n} ${n === 1 ? 'návyk' : n < 5 ? 'návyky' : 'návyků'} dnes`,
    ...
    daysLeftShort: (n: number) =>
      `ještě ${n} ${n === 1 ? 'den' : n < 5 ? 'dny' : 'dní'} do konce týdne`,
    daysLeftThisWeek: (n: number) =>
      `${n} ${n === 1 ? 'den' : n < 5 ? 'dny' : 'dní'} do konce týdne`,
    habitsSection: 'VAŠE NÁVYKY',
    activeCount: (n: number) => `${n} aktivní`,
    uncategorized: 'Ostatní',
    categoryOrderLabel: 'Pořadí kategorií',
    everyDay: 'Everyday',
  ...
  activity: {
    ...
    newCategoryLabel: 'Nová',
    newCategoryPlaceholder: 'Název kategorie',
